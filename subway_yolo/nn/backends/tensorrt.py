...
from subway_yolo.utils import IS_JETSON, LINUX, LOGGER, PYTHON_VERSION
from subway_yolo.utils.checks import check_requirements, check_version
...
class TensorRTBackend(BaseBackend):
    ...
    def load_model(self, weight: Union[str, Path]) -> None:
        ...
        Args:
            weight (Union[str, Path]): Path to the .engine file with optional embedded metadata.
        """
