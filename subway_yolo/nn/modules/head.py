...
from subway_yolo.utils import NOT_MACOS14
from subway_yolo.utils.tal import dist2bbox, dist2rbox, make_anchors
from subway_yolo.utils.torch_utils import TORCH_1_11, fuse_conv_and_bn, smart_inference_mode
    ...
    def forward(self, x: List[torch.Tensor], batch: dict | None = None) -> tuple | torch.Tensor:
        ...
        Returns:
            outputs (tuple | torch.Tensor): During training, returns a tuple of bounding boxes, scores, and other
                ...
                class scores.
        """
        from subway_yolo.models.utils.ops import get_cdn_group
