...
from subway_yolo.cfg import TASK2DATA, get_cfg, get_save_dir
from subway_yolo.engine.results import Results
from subway_yolo.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            model (Union[str, Path] | Model): Path or name of the model to load or create. Can be a local file path, a model
        ...
        if self.is_hub_model(model):
            from subway_yolo.hub import HUBTrainingSession
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        Args:
            source (Union[str, Path] | int | PIL.Image | np.ndarray | torch.Tensor | list | tuple): The source of the image(s)
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        from subway_yolo.hub import HUB_WEB_ROOT
    ...
    def embed(
        ...
        **kwargs: Any,
        ...
        Args:
            source (Union[str, Path] | int | list | tuple | np.ndarray | torch.Tensor): The source of the image for generating
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from subway_yolo.trackers import register_tracker
    ...
    def benchmark(self, data=None, format="", verbose=False, **kwargs: Any):
        ...
        Args:
            data (Optional[str]): Path to the dataset for benchmarking. If None, uses default dataset for the task.
        ...
        """
        self._check_is_pytorch_model()
        from subway_yolo.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from subway_yolo.utils.tuner import run_ray_tune
