...
from subway_yolo.nn.tasks import load_checkpoint
from subway_yolo.optim import MuSGD
...
from subway_yolo.utils.checks import check_amp, check_file, check_imgsz, check_model_file_from_stem, print_args
from subway_yolo.utils.dist import ddp_cleanup, generate_ddp_command
from subway_yolo.utils.files import get_latest_run
from subway_yolo.utils.plotting import plot_results
...
class BaseTrainer:
    ...
    def _clear_memory(self, threshold: Optional[float] = None):
    ...
    def read_results_csv(self):
        ...
        import polars as pl  # scope for faster 'import subway_yolo'
    ...
    def get_dataset(self):
        ...
        try:
            ...
            if data_str.endswith(".ndjson") or (data_str.startswith("ul://") and "/datasets/" in data_str):
                ...
                from subway_yolo.data.converter import convert_ndjson_to_yolo
                from subway_yolo.utils.checks import check_file
    ...
    def validate(self):
        ...
        Returns:
            (tuple): A tuple containing:
                ...
                - fitness (Optional[float]): Fitness score for the validation, or None if validation was skipped.
        """
