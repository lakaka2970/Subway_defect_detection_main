...
from subway_yolo.data import ClassificationDataset, build_dataloader
from subway_yolo.engine.trainer import BaseTrainer
from subway_yolo.models import yolo
from subway_yolo.nn.tasks import ClassificationModel
from subway_yolo.utils import DEFAULT_CFG, LOGGER, RANK
from subway_yolo.utils.plotting import plot_images
from subway_yolo.utils.torch_utils import is_parallel, torch_distributed_zero_first
...
class ClassificationTrainer(BaseTrainer):
    ...
    Examples:
        ...
        >>> from subway_yolo.models.yolo.classify import ClassificationTrainer
    ...
    def setup_model(self):
        ...
        """
        import torchvision  # scope for faster 'import subway_yolo'
