...
from subway_yolo.engine.validator import BaseValidator
from subway_yolo.utils import LOGGER, RANK
from subway_yolo.utils.metrics import ClassifyMetrics, ConfusionMatrix
...
class ClassificationValidator(BaseValidator):
    ...
    Examples:
        >>> from subway_yolo.models.yolo.classify import ClassificationValidator
    ...
    def __init__(self, dataloader=None, save_dir=None, args=None, _callbacks: dict | None = None) -> None:
        ...
        Args:
            ...
            save_dir (Union[str, Path], optional): Directory to save results.
