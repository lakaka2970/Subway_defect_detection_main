...
from subway_yolo.utils import IS_JETSON, LOGGER, TORCH_VERSION, ThreadingLocked
from subway_yolo.utils.torch_utils import TORCH_2_4, TORCH_2_9
...
def onnx2engine(
    ...
    Args:
        ...
        engine_file (Optional[str]): Path to save the generated TensorRT engine file.
        workspace (Optional[int]): Workspace size in GB for TensorRT.
        half (bool, optional): Enable FP16 precision.
        int8 (bool, optional): Enable INT8 precision.
        dynamic (bool, optional): Enable dynamic input shapes.
        shape (tuple[int, int, int, int], optional): Input shape (batch, channels, height, width).
        dla (Optional[int]): DLA core to use (Jetson devices only).
