...
from subway_yolo.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from subway_yolo.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _log_images(experiment, image_paths, curr_step: Optional[int], annotations=None) -> None:
    ...
    Args:
        ...
        curr_step (Optional[int]): Current training step/iteration for tracking in the experiment timeline.
...
def _log_plots(experiment, trainer) -> None:
    ...
    Examples:
        >>> from subway_yolo.utils.callbacks.comet import _log_plots
