...
from subway_yolo.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from subway_yolo.utils.checks import check_font, check_version, is_ascii
...
class Colors:
    ...
    Examples:
        >>> from subway_yolo.utils.plotting import Colors
        >>> colors = Colors()
...
class Annotator:
    ...
    Examples:
        >>> from subway_yolo.utils.plotting import Annotator
...
def save_one_box(
    ...
    Examples:
        >>> from subway_yolo.utils.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
