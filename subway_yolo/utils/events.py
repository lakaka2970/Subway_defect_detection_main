...
from subway_yolo import SETTINGS, __version__
from subway_yolo.utils import ARGV, ENVIRONMENT, GIT, IS_PIP_PACKAGE, ONLINE, PYTHON_VERSION, RANK, TESTS_RUNNING
from subway_yolo.utils.downloads import GITHUB_ASSETS_NAMES
