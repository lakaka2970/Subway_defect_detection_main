...
from subway_yolo.cfg import TASK2DATA, TASK2METRIC, get_cfg, get_save_dir
from subway_yolo.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks, colorstr
...
def _get_ray_search_alg_kind(search_alg):
    ...
    Returns:
        Optional[str]: The normalized search algorithm name, or None if not recognized.
    """
