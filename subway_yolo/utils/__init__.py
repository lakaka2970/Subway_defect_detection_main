...
from subway_yolo.utils.git import GitRepo
from subway_yolo.utils.patches import imread, imshow, imwrite, torch_save  # for patches
from subway_yolo.utils.tqdm import TQDM  # noqa
...
def plt_settings(rcparams=None, backend="Agg"):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            import matplotlib.pyplot as plt  # scope for faster 'import subway_yolo'
...
class ThreadingLocked:
    ...
    Examples:
        >>> from subway_yolo.utils import ThreadingLocked
        >>> @ThreadingLocked()
        ... def my_function():
        ...    # Your code here
    """
...
class YAML:
    ...
    def save(cls, file="data.yaml", data=None, header=""):
        ...
        Args:
            file (Union[str, Path]): Path to save YAML file.
    ...
    def load(cls, file="data.yaml", append_filename=False):
        ...
        Args:
            file (Union[str, Path]): Path to YAML file.
    ...
    def print(cls, yaml_file):
        ...
        Args:
            yaml_file (Union[str, Path] | dict): Path to YAML file or dict to print.
        """
        instance = cls._get_instance()
...
def is_jetson(jetpack=None) -> bool:
    ...
    Args:
        jetpack (Optional[int]): If specified, check for specific JetPack version (4, 5, 6).
...
def colorstr(*input):
    ...
    Args:
        *input (Union[str, Path]): A sequence of strings where the first n-1 strings are color and style arguments, and the
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        from subway_yolo.utils.torch_utils import torch_distributed_zero_first
