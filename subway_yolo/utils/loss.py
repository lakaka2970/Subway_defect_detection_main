...
from subway_yolo.utils.metrics import OKS_SIGMA, RLE_WEIGHT
from subway_yolo.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from subway_yolo.utils.tal import RotatedTaskAlignedAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
...
class BboxLoss(nn.Module):
    ...
    def __init__(self, reg_max: int = 16, iou_type: str = "CIoU"):
        ...
        Args:
            ...
            iou_type (str): IoU variant for box loss. Options: "CIoU" (default), "WIoU".
        """
        super().__init__()
...
class FocalLoss(nn.Module):
    """
    Focal Loss wrapper for YOLOv11.
...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk: int = 10, tal_topk2: Optional[int] = None):  # model must be de-paralleled
...
class v8OBBLoss(v8DetectionLoss):
    ...
    def __init__(self, model, tal_topk=10, tal_topk2: Optional[int] = None):
