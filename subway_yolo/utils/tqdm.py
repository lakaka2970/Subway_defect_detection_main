...
class TQDM:
    ...
    Attributes:
        ...
        total (Optional[int]): Expected number of iterations.
        ...
        bar_format (Optional[str]): Custom bar format string.
    ...
    def __init__(
        ...
        bar_format: Optional[str] = None,  # kept for API compatibility; not used for formatting
        initial: int = 0,
        **kwargs,
    ) -> None:
        ...
        if disable is None:
            try:
                from subway_yolo.utils import LOGGER, VERBOSE
