...
_UNIFIED_STAGES: Dict[str, Dict] = {
    ...
    "1a": {"label": "Stage 1A: Public Defect Head/Neck Warmup",    "vram_gb": 8.0,
           "config_key": "stage1a_public_head", "name": "stage1a_head"},
    "1b": {"label": "Stage 1B: Public Defect Backbone Adaptation",  "vram_gb": 8.0,
           "config_key": "stage1b_public_backbone", "name": "stage1b_backbone"},
    "1":  {"label": "Stage 1 (Legacy): Public Defect Pretraining", "vram_gb": 8.0,
