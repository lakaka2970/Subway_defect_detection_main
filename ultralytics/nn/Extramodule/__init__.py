...
# Project custom attention modules — bridged from the project's modules/
# package so that tasks.py's ``from .Extramodule import *`` exposes them
# in parse_model's globals() for YAML-based module resolution.
